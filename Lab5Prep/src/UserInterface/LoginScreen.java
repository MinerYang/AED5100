...
public class LoginScreen extends javax.swing.JPanel {
    ...
    public LoginScreen(JPanel panelRight, List<User> list,String c) {
        initComponents();
        this.list = list;
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        int x = comboUser.getSelectedIndex();
        if (x<0) {
            JOptionPane.showMessageDialog(null, "Please Select a Item");
            return;
        }
        User us = (User)comboUser.getSelectedItem();
        String tm = txtPword.getText();
        if (us.verify(tm) == false){
            JOptionPane.showMessageDialog(null, "Wrong Password");
            return;
        }
        CardLayout layout = (CardLayout)panelRight.getLayout();
        panelRight.add(new SuccessScreen(us));
